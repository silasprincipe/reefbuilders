...
# Current and future projections of *Mussismilia hispida* niche
...
r <- raster("maps/muhi_current.tif")

pts <- read.csv("data/muhi_cell.csv")
...
binpal <- colorBin(c("#2c3e50","#00DBC7"), c(0,1),na.color = NA, 2, pretty = FALSE)
```

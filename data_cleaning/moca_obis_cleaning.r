...
#Full data
write.csv(sp.clean, file = "data_cleaning/moca_obis_complete.csv", 
          row.names = FALSE)
...
write.csv(sp.points, file = "data_cleaning/moca_obis_pa.csv",
          row.names = FALSE)
...
write.csv(sp.points, file = "data_cleaning/moca_obis.csv", 
          row.names = FALSE)

...
species <- c("Siderastrea stellata", "Siderastrea radians")
...
#Remove the point from Italy
sp.sea <- sp.sea[-7018, ] #Note that when running this code again
                          # this number can change. Verify it!
...
#Full data
write.csv(sp.cl, file = "data_cleaning/side_gbif_complete.csv",
          row.names = FALSE)
...
write.csv(sp.points, file = "data_cleaning/side_gbif.csv",
          row.names = FALSE)

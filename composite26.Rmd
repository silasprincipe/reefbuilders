---
title: "Composition of suitable habitat - RCP 2.6"
output:
  html_document:
    toc: true
    toc_depth: 2
...
# Composition of species - RCP 2.6 Scenario
...
r <- raster("maps/rcp26_composition_change.tif")
...
pal <- colorFactor(c("#fa5f05", "#f3b70d", "#fcff2d","#2c3e50",
                     "#b0f4ef","#44eab0","#0a7b4e"), 
...
r <- raster("maps/rcp26_composition_species.tif")
